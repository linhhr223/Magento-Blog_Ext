...
namespace Smartosc\Sumup\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface
{
    ...
    private $scopeConfig;
    /**
     * @var \Smartosc\Sumup\Model\ResourceModel\Post\CollectionFactory
     */
    ...
    public function __construct(
        ...
        \Smartosc\Sumup\Model\ResourceModel\Post\CollectionFactory $postCollectionFactory
    ) {
    ...
    public function match(RequestInterface $request)
    {
        ...
        if (count($requestParts) == 1) {
            ...
            /* @var \Smartosc\Sumup\Model\Blog $post */
